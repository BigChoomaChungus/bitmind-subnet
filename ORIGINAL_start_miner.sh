# THIS IS THE ORIGINAL FILE FROM BITMIND. IT REFERENCES
# MINER_ENV TO RUN ONE MINER WITH A PM2 INSTANCE.
# I AM CREATING AN ALTERNATE VERSION THAT BYPASSES
# MINER_ENV AND HAS ABSOLUTE FLAGS, AND TRY TO RUN
